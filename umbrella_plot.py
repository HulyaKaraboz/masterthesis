...
#df = pd.read_csv('u_grip.csv')
FILESPACE="C:\FILESPACE"
df = pd.read_csv(os.path.normpath(FILESPACE+'/data/'+"u_grip.csv"))
#print(type(df))
print(df)
...
axs1 = sns.lineplot(data=rslt_df, x="calcTimestamp", y="calcOrientationX", lw=0.1, estimator=None, units='id_no')
#axs1 = rslt_df.plot.scatter(x='calcTimestamp', y='orientationX', c='red')
axs1.set_title('Orientation X (Umbrella)')
axs1.set_xlabel('timestamp')
axs1.set_ylabel('orientation X')
plt.savefig("u_orientationX_plot.pdf".format('calcOrientationX'), format="pdf", bbox_inches="tight")
plt.show()
...
axs2.set_title('Orientation Y (Umbrella)')
axs2.set_xlabel('timestamp')
axs2.set_ylabel('orientation Y')
plt.savefig("u_orientationY_plot.pdf".format('orientationY'), format="pdf", bbox_inches="tight")
plt.show()
...
axs3.set_title('Orientation Z (Umbrella)')
axs3.set_xlabel('timestamp')
axs3.set_ylabel('orientation Z')
plt.savefig("u_orientationZ_plot.pdf".format('orientationZ'), format="pdf", bbox_inches="tight")
plt.show()
...
axs4.set_title('Accelerometer X (Umbrella)')
axs4.set_xlabel('timestamp')
axs4.set_ylabel('accelerometer X')
plt.savefig("u_accelerometerX_plot.pdf".format('accelerometerX'), format="pdf", bbox_inches="tight")
plt.show()
...
axs5.set_title('Accelerometer Y (Umbrella)')
axs5.set_xlabel('timestamp')
axs5.set_ylabel('accelerometer Y')
plt.savefig("u_accelerometerY_plot.pdf".format('accelerometerY'), format="pdf", bbox_inches="tight")
plt.show()
...
axs6.set_title('Accelerometer Z (Umbrella)')
axs6.set_xlabel('timestamp')
axs6.set_ylabel('accelerometer Z')
plt.savefig("u_accelerometerZ_plot.pdf".format('accelerometerZ'), format="pdf", bbox_inches="tight")
plt.show()
...
axs7.set_title('Gyroscope X (Umbrella)')
axs7.set_xlabel('timestamp')
axs7.set_ylabel('gyroscope X')
plt.savefig("u_gyroscopeX_plot.pdf".format('gyroscopeX'), format="pdf", bbox_inches="tight")
plt.show()
...
axs8.set_title('Gyroscope Y (Umbrella)')
axs8.set_xlabel('timestamp')
axs8.set_ylabel('gyroscope Y')
plt.savefig("u_gyroscopeY_plot.pdf".format('gyroscopeY'), format="pdf", bbox_inches="tight")
plt.show()
...
axs9.set_title('Gyroscope Z (Umbrella)')
axs9.set_xlabel('timestamp')
axs9.set_ylabel('gyroscope Z')
plt.savefig("u_gyroscopeZ_plot.pdf".format('gyroscopeZ'), format="pdf", bbox_inches="tight")
plt.show()